...
router.post(
  ...
  (req, res) => {
    ...
    // Offered services
    if (req.body.catsitting === 'true'){
      profileFields.catsitting = true;
    } else {
      profileFields.catsitting = false;
    }
    if (req.body.dogwalking === 'true'){
      profileFields.dogwalking = true;
    } else {
      profileFields.dogwalking = false;
    }
    ...
    // Create or Edit current user profile with unique username
    Profile
      ...
      .then(profile => {
        ...
        // Create new profile
        if(!profile){
          // Check if username exists (username should be unique for all profile)
          Profile
